...
#
#     PHX_SERVER=true bin/kids_media start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :kids_media, KidsMediaWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :kids_media, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :kids_media, KidsMedia.Mailer,
