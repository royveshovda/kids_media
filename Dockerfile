...
#   - https://hub.docker.com/_/debian?tab=tags&page=1&name=bookworm-20240110-slim - for the release image
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/kids_media ./
